...
//controllers
import { getAllConsums, getConsumoByDispatchId, processConsum, processManyConsums, createConsum, addConsum } from './consum.controller.js';
...
router.post(`/api/consums/addConsum`, addConsum);
